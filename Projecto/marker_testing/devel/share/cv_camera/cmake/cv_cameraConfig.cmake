...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/doblas/TFG/Projecto/marker_testing/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/doblas/TFG/Projecto/marker_testing/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/doblas/TFG/Projecto/marker_testing/install)
...
if(NOT "/home/doblas/TFG/Projecto/marker_testing/src/cv_camera/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/doblas/TFG/Projecto/marker_testing/src/cv_camera/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/doblas/TFG/Projecto/marker_testing/src/cv_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/doblas/TFG/Projecto/marker_testing/devel/lib;/home/doblas/TFG/Projecto/marker_testing/devel/lib;/home/doblas/ros_ws_cam/devel/lib;/opt/ros/melodic/lib)
