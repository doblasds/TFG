...
void CameraNode::send_marker(){ 
    ...
    marker.pose.position.x = fiducial_world_pose.position.x;
    marker.pose.position.y = fiducial_world_pose.position.y;
    marker.pose.position.z = fiducial_world_pose.position.z;
